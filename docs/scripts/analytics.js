(function() {
    ...
    var O = f, M = document, xa = function(a) {
        ...
        return d
    }, za = new RegExp(/^(www\.)?google(\.com?)?(\.[a-z]{2})?$/), Aa = new RegExp(/(^|\.)doubleclick\.net$/i), Mc = function() {
    ...
    Wc = T("legacyHistoryImport", void 0, !0), ac = T("storage", void 0, "cookie"), bc = T("allowLinker", void 0, !1), cc = T("allowAnchor", void 0, !0), Ka = T("sampleRate", "sf", 100), dc = T("siteSpeedSampleRate", void 0, 1), ec = T("alwaysSendReferrer", void 0, !1), gd = S("transportUrl"), Md = S("_r", "_r"), Nd = S("_dfr", void 0, 10);
    function X(a, b, c, d) {
        b[a] = function() {
            try {
    ...
    var hc=!1, mc = function(a) {
        if ("cookie" == P(a, ac)) {
            ...
            if ("auto" != e)
                ...
                for (var k = 0; k < l[y]; k++)
                    if (e = l[k], a[q].set(W, e)
                        , c = nd(a), zc(b, c, d, e, ca, g)) {
                    hc=!0;
                    return 
                }
                a[q].set(W, "auto")
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function(a) {
        ...
        var c = M.documentElement, g = (e = M.body) && e[la] && e[na], ca = [];
        c && c[la] && c[na] && ("CSS1Compat" ===
        M.compatMode ||!g) ? ca = [c[la], c[na]] : g && (ca = [e[la], e[na]]);
        ...
        if (d && a.get(cc) && (b = M[B][h])) {
            b = b[A](/[?&#]+/);
            d = [];
            for (c = 0; c < b[y]; ++c)(ea(b[c], "utm_id") || ea(b[c], "utm_campaign") || ea(b[c], "utm_source") || ea(b[c], "utm_medium") || ea(b[c], "utm_term") || ea(b[c], "utm_content") || ea(b[c], "gclid") ||
            ea(b[c], "dclid") || ea(b[c], "gclsrc")
                ) && d[p](b[c]);
    ...
    var tc = function(a, b, c) {
        ...
        ea(a, "//") ? a = d + a : ea(a, "/") ? a = ca + a :
        !a || ea(a, "?") ? a = ca + e[2] + (a || g) : 0 > a[A]("/")[0][t](":") && (a = ca + e[2][F](0, e[2].lastIndexOf("/")) + "/" + a);
        Pc(c, a);
        d = b(c);
        return {
            protocol: (c[E] || "")[I](),
